            ...
            <main>
                ...
                <div class="row justify-content-center align-items-center" style="min-height: 76vh;">
                    ...
                    <div class="col-md-7 bg-light p-5 rounded">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item active" aria-current="true"><a href="?p=1">1. Registro de usuarios</a></li>
                        ...
                        <div class="container cuerpoAyuda">
                            <div class="col-12 rounded pt-4 pb-1">
                                ...
                                <p>Para usar la aplicación, el usuario se tiene que registrar en el sistema para tener una cuenta en la base de datos que le servirá para utilizar la aplicación.
                                    <br><br>Para ello, estando en la pantalla de Login, vamos al botón “Registrarse”<br><br>
                                    <img src="../View/img/ayuda/captura1.png" class="img-fluid" alt="..."><br><br>
                                    A continuación, nos aparecerá un formulario de registro donde tendremos que tener en cuenta algunas cosas:<br>
                                    - El DNI deberá estar formado por 8 números y 1 letra<br>
                                    - El DNI y el Email son únicos para cada usuario.<br>
                                    Una vez se completen todos los campos, deberemos dar click en el botón “Enviar”<br><br>
                                    <img src="../View/img/ayuda/captura2.png" class="img-fluid" alt="..."><br><br>
                                    Si todo ha ido bien, veremos el siguiente mensaje:<br><br>
                                    <img src="../View/img/ayuda/captura3.png" class="img-fluid" alt="..."><br><br>
                                </p>
                            </div>
                        </div>
                    </div>
